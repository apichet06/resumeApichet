                    ...
                    <Col md={6}>
                        <ul className='text-start py-2'>
                            <li>
                                <h3>ระบบ Stock</h3>
                                <ul>
                                    <li>พัฒนาขึ่้นเพื่อเก็บข้อมูลสินค้าและส่งออกเครื่องเล่นไปยังสาขาต่างๆและสามารถติดตามเครื่องเล่นนั้นๆได้และสามารถเช็คอายุการใช้งานเครื่องเล่นนั้นๆได้
                                        เพื่อมาประเมินในการซ่อมบำรุงครั้งต่อไป</li>
                                    <li>สามารถบันทึกข้อมูลสินค้า และส่งออกไปยังสาขาต่างๆได้ สามารถ สรุปรายงานและ Export Excel ได้</li>
                                    <li>พัฒนาด้วย Php version 5, Mysql, Bootstrap 4,javascript, Line notifications</li>
                                </ul>
                            </li>
                        </ul>
